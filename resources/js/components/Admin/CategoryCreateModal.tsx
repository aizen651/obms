...
export default function CategoryCreateModal({ isOpen, onClose }) {
    ...
    const handleClose = () => { if (!form.processing) { onClose(); form.reset(); } };
    const handleSubmit = (e) => {
        e.preventDefault();
        form.post('/admin/categories', {
            onSuccess: () => { toast.success('Category created!'); handleClose(); },
            onError: () => toast.error('Failed to create category. Check the form.'),
        });
    };
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4 rounded-t-2xl flex items-center justify-between flex-shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100 text-sm">Add a new book category</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <textarea value={form.data.description} onChange={e => form.setData('description', e.target.value)}
                                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none resize-none"
                                    placeholder="Brief description of this category..." rows={4} />
                            </div>
