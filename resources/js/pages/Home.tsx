  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen w-full bg-[#032e26] text-white selection:bg-emerald-500 overflow-x-hidden">
        ...
        {/* ══ NAVBAR ═══════════════════════════════════════════════ */}
        {/* z-[110]: always above the mobile overlay (z-[100]) */}
        ...
        {/* ══ MOBILE MENU — lives outside <header> so fixed positioning is reliable ══ */}
        {/* z-[100]: above page, below navbar (z-110). Chat button is z-[90] — always under this. */}
        <div
          className={`md:hidden fixed inset-0 bg-[#032e26] z-[100]
            transition-transform duration-500 ease-in-out
            ${open ? "translate-y-0 pointer-events-auto" : "-translate-y-full pointer-events-none"}`}
        >
          {/* pt-28 places labels just below the navbar; justify-start keeps them near top */}
